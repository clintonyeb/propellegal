...
$results = getAdminReviews($limit, $page, $query);
$back = "";
$forward = "";
        ...
        <div class="column is-4">
            <div class="box has-top-yellow">
                ...
                <div class="field has-addons">
                    ...
                    <div class="control" id="req-search-btn" data-url="/admin/document_reviews">
        ...
        <div class="column">
            <div class="box has-top-blue">
                ...
                <table class="table is-striped is-hoverable is-fullwidth">
                    <input type=hidden value="REVIEW_DOCUMENT" id=action>
                    <tbody>
                        <?php
                        $c = count($results);
                        if ($c < 1){
