            ...
            <nav class="navbar is-black">
                ...
                <div id="main-menu" class="navbar-menu">
                    <div class="navbar-start">
                        <a class="nav-item" data-scroll="general">
                            SERVICES
                        </a>
                        <a class="nav-item" href="/how-it-works">
                            HOW IT WORKS
                        </a>
                    ...
                    <div class="cont">
                        ...
                        <div class="field">
                            <p class="has-text-centered">
                                <a class="button is-darker-yellow has-text-dark is-large" id="business-ask">Ask an Attorney</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="columns">
                ...
                <div class="column">
                    <div class="box box-cont">
                        ...
                        <textarea class="textarea is-medium" placeholder="e.g. What is the likely outcome in my case?" rows="7"></textarea>
                        <p class="has-text-centered">
