...
rules.fileSize = function (file, b, size) {
    rules.fileSize.reason = 'file size exceeds limit of 10MB';
    if (!b) return true;
...
rules.isFileImage = function (file) {
    rules.isFileImage.reason = 'file is not an image';
